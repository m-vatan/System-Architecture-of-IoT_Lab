...
String group = "Group2";   // UPDATE THIS with an unique name for your group
...
/////////////////////////////////////////
String LEDTopic = "saiot/" + group + "/led";
String TEMPTopic = "saiot/" + group + "/temp";
/////////////////////////////////////////
...
void setup() {
  ...
  mqttClient.subscribe(LEDTopic, 1);
...
// use the Stream interface to print the contents
  while (mqttClient.available()) {
    msg_body += (char)mqttClient.read();
  }
  
  if (msg_body.equals("ON")){
    digitalWrite(LED_BUILTIN, 1);
    Serial.print(" LED is ON");
    }
    else if (msg_body.equals("OFF")){
    digitalWrite(LED_BUILTIN, 0);
    Serial.print(" LED is OFF");
    }
    else if (msg_body.equals("TEMP")){
